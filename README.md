...
:80 {
    reverse_proxy https://dns.nextdns.io {
        ...
        # 请将 XXXXXX 替换为你 NextDNS 后台的专属 ID
        header_up X-NextDNS-ID XXXXXX 
